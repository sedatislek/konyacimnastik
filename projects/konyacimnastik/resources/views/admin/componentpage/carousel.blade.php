            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-0 default-carousel">
                    <div class="gradient-overlay bottom-0 start-0 h-100">
                        <img src="{{ asset('admin-assets/assets/images/carousel/carousel-img1.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                    ...
                    <div class="gradient-overlay bottom-0 start-0 h-100">
                        <img src="{{ asset('admin-assets/assets/images/carousel/carousel-img2.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                        <div class="position-absolute start-50 translate-middle-x bottom-0 pb-24 z-1 text-center w-100 max-w-440-px">
                    ...
                    <div class="gradient-overlay bottom-0 start-0 h-100">
                        <img src="{{ asset('admin-assets/assets/images/carousel/carousel-img3.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                        <div class="position-absolute start-50 translate-middle-x bottom-0 pb-24 z-1 text-center w-100 max-w-440-px">
        ...
        <div class="col-sm-6">
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-0 arrow-carousel">
                    ...
                    <div class="gradient-overlay bottom-0 start-0 h-100">
                        <img src="{{ asset('admin-assets/assets/images/carousel/carousel-img4.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                        <div class="position-absolute start-50 translate-middle-x bottom-0 pb-24 z-1 text-center w-100 max-w-440-px">
                            <h5 class="card-title text-white text-lg mb-6">Carousel Slide Two</h5>
                            <p class="card-text text-white mx-auto text-sm">User Interface (UI) and User Experience (UX) Design play key roles in the experience users have when </p>
                        </div>
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body py-24 px-16 multiple-carousel dots-style-circle">
                    <div class="mx-8 mb-24">
                        <img src="{{ asset('admin-assets/assets/images/carousel/mutiple-carousel-img1.png') }}" class="w-100 h-100 object-fit-cover" alt="">
                    </div>
                    <div class="mx-8 mb-24">
                        <img src="{{ asset('admin-assets/assets/images/carousel/mutiple-carousel-img2.png') }}" class="w-100 h-100 object-fit-cover" alt="">
                    </div>
                    <div class="mx-8 mb-24">
                        <img src="{{ asset('admin-assets/assets/images/carousel/mutiple-carousel-img3.png') }}" class="w-100 h-100 object-fit-cover" alt="">
                    </div>
                    <div class="mx-8 mb-24">
                        <img src="{{ asset('admin-assets/assets/images/carousel/mutiple-carousel-img4.png') }}" class="w-100 h-100 object-fit-cover" alt="">
                    </div>
                    <div class="mx-8 mb-24">
                        <img src="{{ asset('admin-assets/assets/images/carousel/mutiple-carousel-img2.png') }}" class="w-100 h-100 object-fit-cover" alt="">
                    </div>
